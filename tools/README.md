...
python tools/generate_images.py --provider leonardo --model gpt-image-2 --type recipes  # 40 recipe photos
...
- **GPT Image 2 via Leonardo** (what the site uses), 1024×1024, LOW: ~**8 Leonardo tokens + ~$0.012**
  per image. The full set (40 recipes + 11 + 8 + 16 icons + logo = 76) ≈ **~$0.9 + ~600 tokens**.
